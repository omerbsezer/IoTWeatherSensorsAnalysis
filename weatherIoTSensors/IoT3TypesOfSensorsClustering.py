...
def normalize_3values(input_table):
    ...
    min_col5 = input_table.iloc[:, [5]].min()
    max_col5 = input_table.iloc[:, [5]].max()

    for i in range(len(input_table)):
        input_table.iloc[i, [5]] = ((input_table.iloc[i, [5]] - min_col5) / (max_col5 - min_col5))
...
# specific features
table3=table.iloc[:,[0,4,5,1,7,11]]
...
min_feature3=table3.iloc[:, [5]].min()
max_feature3=table3.iloc[:, [5]].max()
table3_normalized=normalize_3values(table3)


print(table3_normalized.tail())
feature1="AirTemp"
feature2="RelativeHumidity"
feature3="WindSpeed"
...
weather_clusters=table3[["Name","Lat","Longt","Cluster",feature1,feature2,feature3]]
...
for r in range(len(denormalized_centroids)):
    ...
    denormalized_centroids[r][2] = (denormalized_centroids[r][2] * (max_feature3 - min_feature3)) + min_feature3

# after denormalizing, centroids:
print("denormalized centroids:", feature1,feature2,feature3 )
...
if k==2:
    ...
    c4=pl.scatter(x_3,y_3,c='y',marker='o', alpha=0.4)
    # Numbers of Elements in Clusters
...
pl.xlabel('Longitude')
pl.ylabel('Latitude')
pl.title('AirTemp, RelativeHumidity, WindSpeed')
